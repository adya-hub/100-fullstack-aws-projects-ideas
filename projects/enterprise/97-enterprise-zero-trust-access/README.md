# Zero Trust Access Gateway
        ...
        > **Level:** Enterprise · **Project 97** · [`97-enterprise-zero-trust-access`](./)

        Policy-based access to internal apps with device posture and session recording.

        ## Overview

        Zero Trust Access Gateway is a production-oriented full stack application demonstrating modern web development
...
- App catalog
        ...
        | Database | PostgreSQL |
        | Authentication | OIDC |
        | AWS | IAM, Verified Access, CloudTrail, WAF |
...
- Access policies
        ...
        ```
        97-enterprise-zero-trust-access/
        ├── README.md
        ├── architecture.md
        ├── docker-compose.yml
        ├── .env.example
