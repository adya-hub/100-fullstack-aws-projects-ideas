# Manufacturing MES Lite

        > **Level:** Enterprise · **Project 88** · [`88-enterprise-manufacturing-mes`](./)

        Production orders, work centers, quality checks, and OEE dashboards.

        ## Overview

        Manufacturing MES Lite is a production-oriented full stack application demonstrating modern web development
...
- Andon
        ...
        | Authentication | SAML |
        | AWS | IoT Core, Timestream, RDS, QuickSight |
...
- OEE metrics
        ...
        ```
        88-enterprise-manufacturing-mes/
        ├── README.md
        ├── architecture.md
        ├── docker-compose.yml
        ├── .env.example
