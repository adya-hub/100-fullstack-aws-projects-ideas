# Digital Banking Portal Lite

        > **Level:** Enterprise · **Project 86** · [`86-enterprise-banking-portal`](./)

        Accounts, transfers, statements, and fraud alerts with audit trails.

        ## Overview

        Digital Banking Portal Lite is a production-oriented full stack application demonstrating modern web development
...
- Fraud alerts
        ...
        | AWS | RDS encrypted, KMS, CloudTrail, Fraud Detector |
