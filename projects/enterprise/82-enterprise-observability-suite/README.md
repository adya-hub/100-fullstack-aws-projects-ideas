# Enterprise Observability Suite
        ...
        > **Level:** Enterprise · **Project 82** · [`82-enterprise-observability-suite`](./)

        Unified metrics, logs, traces, SLOs, and on-call management.

        ## Overview

        Enterprise Observability Suite is a production-oriented full stack application demonstrating modern web development
...
- SLO/error budgets
        ...
        ```
        82-enterprise-observability-suite/
        ├── README.md
        ├── architecture.md
        ├── docker-compose.yml
        ├── .env.example
