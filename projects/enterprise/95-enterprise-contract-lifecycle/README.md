# Contract Lifecycle Management
        ...
        > **Level:** Enterprise · **Project 95** · [`95-enterprise-contract-lifecycle`](./)

        Contract authoring, negotiations, approvals, obligations, and renewals.

        ## Overview

        Contract Lifecycle Management is a production-oriented full stack application demonstrating modern web development
...
- Renewals
        ...
        | Database | PostgreSQL |
        | Authentication | SAML |
        | AWS | S3, Textract, Step Functions, RDS |
...
- Obligation tracking
        ...
        ```
        95-enterprise-contract-lifecycle/
        ├── README.md
        ├── architecture.md
        ├── docker-compose.yml
        ├── .env.example
