# Enterprise Vendor Portal
        ...
        > **Level:** Enterprise · **Project 93** · [`93-enterprise-vendor-portal`](./)

        Vendor onboarding, PO collaboration, invoicing, and performance scorecards.

        ## Overview

        Enterprise Vendor Portal is a production-oriented full stack application demonstrating modern web development
