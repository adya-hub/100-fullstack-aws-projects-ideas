# Retail Order Management System
        ...
        > **Level:** Enterprise · **Project 89** · [`89-enterprise-retail-oms`](./)

        Omnichannel orders, inventory allocation, fulfillment, and returns.

        ## Overview

        Retail Order Management System is a production-oriented full stack application demonstrating modern web development
...
- Returns
        ...
        | Database | PostgreSQL |
        | Authentication | SAML |
        | AWS | RDS, SQS, EventBridge, Lambda |
