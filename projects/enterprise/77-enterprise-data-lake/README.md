# Enterprise Data Lake Platform
        ...
        > **Level:** Enterprise · **Project 77** · [`77-enterprise-data-lake`](./)

        Ingest, catalog, and query organizational data with governance controls.

        ## Overview

        Enterprise Data Lake Platform is a production-oriented full stack application demonstrating modern web development
...
- Lineage
        ...
        | Frontend | Next.js |
        | Backend | NestJS |
        | Database | S3 + Glue Catalog |
        | Authentication | IAM + SSO |
        | AWS | S3 Lake, Glue, Athena, Lake Formation |
