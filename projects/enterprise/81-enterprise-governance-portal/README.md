# Enterprise Governance Portal
        ...
        > **Level:** Enterprise · **Project 81** · [`81-enterprise-governance-portal`](./)

        Policies, compliance tracking, risk registers, and audit workflows.

        ## Overview

        Enterprise Governance Portal is a production-oriented full stack application demonstrating modern web development
...
- Evidence
        ...
        | Database | PostgreSQL |
        | Authentication | SAML |
        | AWS | RDS, S3 evidence, CloudTrail, Config |
...
- Compliance automation
        ...
        ```
        81-enterprise-governance-portal/
        ├── README.md
        ├── architecture.md
        ├── docker-compose.yml
        ├── .env.example
