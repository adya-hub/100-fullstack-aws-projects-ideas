# Enterprise BPM Suite
        ...
        > **Level:** Enterprise · **Project 80** · [`80-enterprise-bpm-suite`](./)

        Model business processes, human tasks, SLAs, and process analytics.

        ## Overview

        Enterprise BPM Suite is a production-oriented full stack application demonstrating modern web development
...
- Analytics
        ...
        | Database | PostgreSQL |
        | Authentication | SAML |
        | AWS | Step Functions, RDS, EventBridge, OpenSearch |
