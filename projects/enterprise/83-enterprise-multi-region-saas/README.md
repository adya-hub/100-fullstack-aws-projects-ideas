# Multi-Region SaaS Platform
        ...
        > **Level:** Enterprise · **Project 83** · [`83-enterprise-multi-region-saas`](./)

        Globally distributed SaaS with data residency, replication, and failover.

        ## Overview

        Multi-Region SaaS Platform is a production-oriented full stack application demonstrating modern web development
...
- Global LB
        ...
        | AWS | Route53, RDS Global, DynamoDB Global, CloudFront |
...
- DR strategies
        ...
        ```
        83-enterprise-multi-region-saas/
        ├── README.md
        ├── architecture.md
        ├── docker-compose.yml
        ├── .env.example
