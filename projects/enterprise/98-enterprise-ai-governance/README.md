# AI Governance & Model Registry
        ...
        > **Level:** Enterprise · **Project 98** · [`98-enterprise-ai-governance`](./)

        Model registry, bias reports, approval workflows, and inference audit.

        ## Overview

        AI Governance & Model Registry is a production-oriented full stack application demonstrating modern web development
...
- Audit
        ...
        | Database | PostgreSQL |
        | Authentication | SAML |
        | AWS | SageMaker, Bedrock, S3, CloudTrail |
