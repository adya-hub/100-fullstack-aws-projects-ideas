# Enterprise Marketing Hub
        ...
        > **Level:** Enterprise · **Project 90** · [`90-enterprise-marketing-hub`](./)

        Campaign orchestration, CDP-lite profiles, attribution, and journeys.

        ## Overview

        Enterprise Marketing Hub is a production-oriented full stack application demonstrating modern web development
...
- Campaigns
        ...
        | Database | OpenSearch |
        | Authentication | SAML |
        | AWS | Pinpoint, Kinesis, OpenSearch, S3 |
