# Insurance Policy Platform
        ...
        > **Level:** Enterprise · **Project 85** · [`85-enterprise-insurance-platform`](./)

        Quotes, underwriting, policies, claims, and agent portals.

        ## Overview

        Insurance Policy Platform is a production-oriented full stack application demonstrating modern web development
...
- Agent portal
        ...
        | Database | PostgreSQL |
        | Authentication | SAML |
        | AWS | RDS, Step Functions, Textract, SES |
...
- Claims processing
        ...
        ```
        85-enterprise-insurance-platform/
        ├── README.md
        ├── architecture.md
        ├── docker-compose.yml
        ├── .env.example
