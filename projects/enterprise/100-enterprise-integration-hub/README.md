# Enterprise Integration Hub
        ...
        > **Level:** Enterprise · **Project 100** · [`100-enterprise-integration-hub`](./)

        iPaaS-style connectors, transformations, and monitored integrations.

        ## Overview

        Enterprise Integration Hub is a production-oriented full stack application demonstrating modern web development
...
- Replay
        ...
        | Backend | NestJS |
        | Database | PostgreSQL |
        | Authentication | API keys + SAML |
        | AWS | EventBridge, SQS, Lambda, API Gateway |
...
- Event-driven ETL
        ...
        ```
        100-enterprise-integration-hub/
        ├── README.md
        ├── architecture.md
        ├── docker-compose.yml
        ├── .env.example
