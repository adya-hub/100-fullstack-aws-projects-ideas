# Enterprise Asset Management
        ...
        > **Level:** Enterprise · **Project 92** · [`92-enterprise-asset-management`](./)

        Track physical assets, depreciation, maintenance, and compliance.

        ## Overview

        Enterprise Asset Management is a production-oriented full stack application demonstrating modern web development
...
- Asset lifecycle
        ...
        ```
        92-enterprise-asset-management/
        ├── README.md
        ├── architecture.md
        ├── docker-compose.yml
        ├── .env.example
