# Enterprise Event Ticketing
        ...
        > **Level:** Enterprise · **Project 91** · [`91-enterprise-ticketing-platform`](./)

        Large-scale events, dynamic pricing, access control, and resale marketplace.

        ## Overview

        Enterprise Event Ticketing is a production-oriented full stack application demonstrating modern web development
...
- Capacity
        ...
        | Database | PostgreSQL |
        | Authentication | JWT |
        | AWS | RDS, ElastiCache, CloudFront, Lambda |

        ## Learning Outcomes

        - High-scale ticketing
- Dynamic pricing

        ## Repository Layout

        ```
        91-enterprise-ticketing-platform/
        ├── README.md
        ├── architecture.md
        ├── docker-compose.yml
        ├── .env.example
