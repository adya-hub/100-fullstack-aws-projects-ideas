# Telehealth Enterprise Platform

        > **Level:** Enterprise · **Project 87** · [`87-enterprise-telehealth`](./)

        Video visits, scheduling, EHR integration patterns, and prescriptions.

        ## Overview

        Telehealth Enterprise Platform is a production-oriented full stack application demonstrating modern web development
...
- e-Rx patterns
        ...
        | AWS | Chime SDK, RDS, KMS, S3 records |
