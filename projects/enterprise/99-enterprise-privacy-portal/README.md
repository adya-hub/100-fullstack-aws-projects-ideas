# Privacy & Consent Management
        ...
        > **Level:** Enterprise · **Project 99** · [`99-enterprise-privacy-portal`](./)

        Consent banners, DSAR requests, data mapping, and retention policies.

        ## Overview

        Privacy & Consent Management is a production-oriented full stack application demonstrating modern web development
...
- Retention
        ...
        | Database | PostgreSQL |
        | Authentication | SAML |
        | AWS | RDS, Lambda, Macie, CloudTrail |
