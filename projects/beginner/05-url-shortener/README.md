# Enterprise URL Shortener
        ...
        > **Level:** Beginner · **Project 05** · [`05-url-shortener`](./)

        Short links with analytics, custom slugs, and QR code generation.

        ## Overview

        Enterprise URL Shortener is a production-oriented full stack application demonstrating modern web development
...
- Rate limiting
        ...
        | AWS | Lambda, DynamoDB, CloudFront, Route53 |
