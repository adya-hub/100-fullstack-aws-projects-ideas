# Recipe Sharing Community
        ...
        > **Level:** Beginner · **Project 07** · [`07-recipe-sharing-app`](./)

        Share recipes with ingredients, ratings, and meal planning.

        ## Overview

        Recipe Sharing Community is a production-oriented full stack application demonstrating modern web development
