# Contact Manager CRM Lite
        ...
        > **Level:** Beginner · **Project 06** · [`06-contact-manager-crm-lite`](./)

        Manage contacts, notes, and follow-up reminders for small businesses.

        ## Overview

        Contact Manager CRM Lite is a production-oriented full stack application demonstrating modern web development
