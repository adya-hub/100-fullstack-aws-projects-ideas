# Gift Wishlist Registry

        > **Level:** Beginner · **Project 21** · [`21-gift-wishlist-app`](./)

        Create shareable wishlists for events with reservation to avoid duplicates.

        ## Overview

        Gift Wishlist Registry is a production-oriented full stack application demonstrating modern web development
