# Event Countdown Planner
        ...
        > **Level:** Beginner · **Project 11** · [`11-event-countdown-app`](./)

        Count down to events with shared calendars and notification reminders.

        ## Overview

        Event Countdown Planner is a production-oriented full stack application demonstrating modern web development
