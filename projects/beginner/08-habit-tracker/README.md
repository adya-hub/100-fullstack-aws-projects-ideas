# Habit Streak Tracker
        ...
        > **Level:** Beginner · **Project 08** · [`08-habit-tracker`](./)

        Build habits with streaks, reminders, and weekly progress visualization.

        ## Overview

        Habit Streak Tracker is a production-oriented full stack application demonstrating modern web development
...
- Statistics
        ...
        | AWS | Cognito, DynamoDB, EventBridge |
