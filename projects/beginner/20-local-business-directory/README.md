# Local Business Directory
        ...
        > **Level:** Beginner · **Project 20** · [`20-local-business-directory`](./)

        Discover and review local businesses with maps and categories.

        ## Overview

        Local Business Directory is a production-oriented full stack application demonstrating modern web development
