# Poll & Survey Builder
        ...
        > **Level:** Beginner · **Project 15** · [`15-poll-survey-builder`](./)

        Create surveys with multiple question types and real-time result charts.

        ## Overview

        Poll & Survey Builder is a production-oriented full stack application demonstrating modern web development
...
- Export CSV
        ...
        | Database | DynamoDB |
        | Authentication | JWT |
        | AWS | DynamoDB, Lambda, CloudFront |
