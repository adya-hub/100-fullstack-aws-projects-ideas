# Team Todo Application

        > **Level:** Beginner · **Project 02** · [`02-todo-app-with-teams`](./)

        Collaborative task lists with assignments, due dates, and team workspaces.

        ## Overview

        Team Todo Application is a production-oriented full stack application demonstrating modern web development
...
- Activity log
        ...
        | AWS | Cognito, DynamoDB, AppSync, SNS |
