# Movie Watchlist & Reviews
        ...
        > **Level:** Beginner · **Project 09** · [`09-movie-watchlist`](./)

        Track films to watch, ratings, and personalized recommendations.

        ## Overview

        Movie Watchlist & Reviews is a production-oriented full stack application demonstrating modern web development
