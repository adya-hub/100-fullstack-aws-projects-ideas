# Vehicle Maintenance Log
        ...
        > **Level:** Beginner · **Project 24** · [`24-car-maintenance-log`](./)

        Track service history, fuel economy, and maintenance reminders.

        ## Overview

        Vehicle Maintenance Log is a production-oriented full stack application demonstrating modern web development
