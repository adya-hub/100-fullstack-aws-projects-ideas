# Spaced Repetition Flashcards
        ...
        > **Level:** Beginner · **Project 18** · [`18-flashcard-study-app`](./)

        Study decks with spaced repetition algorithm and progress tracking.

        ## Overview

        Spaced Repetition Flashcards is a production-oriented full stack application demonstrating modern web development
...
- Stats
        ...
        | Database | PostgreSQL |
        | Authentication | JWT |
        | AWS | RDS, S3 audio, Lambda grading |
