# Personal Book Library
        ...
        > **Level:** Beginner · **Project 13** · [`13-book-library-manager`](./)

        Catalog books with reading status, notes, and reading goals.

        ## Overview

        Personal Book Library is a production-oriented full stack application demonstrating modern web development
