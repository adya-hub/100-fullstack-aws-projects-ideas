# Plant Care Assistant
        ...
        > **Level:** Beginner · **Project 25** · [`25-plant-watering-reminder`](./)

        Watering schedules, plant identification, and care tips per species.

        ## Overview

        Plant Care Assistant is a production-oriented full stack application demonstrating modern web development
