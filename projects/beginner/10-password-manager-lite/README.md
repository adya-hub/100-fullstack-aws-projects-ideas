# Password Vault Lite
        ...
        > **Level:** Beginner · **Project 10** · [`10-password-manager-lite`](./)

        Encrypted credential storage with master password and breach alerts.

        ## Overview

        Password Vault Lite is a production-oriented full stack application demonstrating modern web development
...
- Categories
        ...
        | AWS | KMS, DynamoDB, Secrets Manager |
