# Modern Blogging Platform
        ...
        > **Level:** Beginner · **Project 04** · [`04-blogging-platform`](./)

        Publish markdown articles with tags, comments, and SEO-friendly pages.

        ## Overview

        Modern Blogging Platform is a production-oriented full stack application demonstrating modern web development
...
- RSS feed
        ...
        | AWS | S3 media, CloudFront, RDS, SES |
