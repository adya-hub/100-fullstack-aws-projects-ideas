# IoT Device Management Dashboard
        ...
        > **Level:** Advanced · **Project 70** · [`70-iot-device-dashboard`](./)

        Device provisioning, telemetry, alerts, and firmware OTA updates.

        ## Overview

        IoT Device Management Dashboard is a production-oriented full stack application demonstrating modern web development
...
- Rules engine
        ...
        | AWS | IoT Core, Timestream, Lambda, SNS |
