# Fraud Detection Dashboard
        ...
        > **Level:** Advanced · **Project 71** · [`71-fraud-detection-dashboard`](./)

        Transaction scoring, rule engine, case management, and ML models.

        ## Overview

        Fraud Detection Dashboard is a production-oriented full stack application demonstrating modern web development
...
- ML inference
        ...
        | Database | PostgreSQL |
        | Authentication | JWT |
        | AWS | SageMaker, Kinesis, OpenSearch, SNS |
