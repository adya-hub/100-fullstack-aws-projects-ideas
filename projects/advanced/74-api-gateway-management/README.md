# API Gateway Management Portal
        ...
        > **Level:** Advanced · **Project 74** · [`74-api-gateway-management`](./)

        Manage APIs, keys, rate limits, analytics, and developer portal.

        ## Overview

        API Gateway Management Portal is a production-oriented full stack application demonstrating modern web development
...
- Docs
        ...
        | Database | DynamoDB |
        | Authentication | JWT |
        | AWS | API Gateway, Lambda, DynamoDB, CloudWatch |
