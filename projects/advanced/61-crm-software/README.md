# Enterprise CRM Software
        ...
        > **Level:** Advanced · **Project 61** · [`61-crm-software`](./)

        Leads, deals pipeline, email integration, and sales forecasting.

        ## Overview

        Enterprise CRM Software is a production-oriented full stack application demonstrating modern web development
...
- Automation
        ...
        | AWS | RDS, OpenSearch, SES, EventBridge |
