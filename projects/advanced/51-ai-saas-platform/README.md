# AI SaaS Platform
        ...
        > **Level:** Advanced · **Project 51** · [`51-ai-saas-platform`](./)

        Multi-tenant AI workspace with model selection, usage billing, and API keys.

        ## Overview

        AI SaaS Platform is a production-oriented full stack application demonstrating modern web development
...
- API keys
        ...
        | AWS | Bedrock, Lambda, DynamoDB, API Gateway, Cognito |
