# Cloud IDE Platform
        ...
        > **Level:** Advanced · **Project 68** · [`68-cloud-ide-platform`](./)

        Browser-based IDE with workspaces, terminals, and collaborative editing.

        ## Overview

        Cloud IDE Platform is a production-oriented full stack application demonstrating modern web development
