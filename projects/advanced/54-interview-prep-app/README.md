# AI Interview Preparation
        ...
        > **Level:** Advanced · **Project 54** · [`54-interview-prep-app`](./)

        Mock interviews with AI feedback, question banks, and progress tracking.

        ## Overview

        AI Interview Preparation is a production-oriented full stack application demonstrating modern web development
...
- Score trends
        ...
        | Database | PostgreSQL |
        | Authentication | JWT |
        | AWS | Bedrock, Transcribe, Polly, S3 recordings |
