# AI Image Generation Studio
        ...
        > **Level:** Advanced · **Project 56** · [`56-ai-image-generator`](./)

        Text-to-image generation with galleries, styles, and credit system.

        ## Overview

        AI Image Generation Studio is a production-oriented full stack application demonstrating modern web development
...
- Upscale
        ...
        | Database | DynamoDB |
        | Authentication | JWT |
        | AWS | Bedrock, S3, CloudFront, DynamoDB |
