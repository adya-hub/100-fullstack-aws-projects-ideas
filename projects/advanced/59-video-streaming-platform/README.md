# Video Streaming Platform
        ...
        > **Level:** Advanced · **Project 59** · [`59-video-streaming-platform`](./)

        Upload, transcode, and stream video with adaptive bitrate playback.

        ## Overview

        Video Streaming Platform is a production-oriented full stack application demonstrating modern web development
...
- Analytics
        ...
        | Database | PostgreSQL |
        | Authentication | JWT |
        | AWS | S3, MediaConvert, CloudFront, Lambda@Edge |
