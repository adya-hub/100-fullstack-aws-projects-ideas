# AI Document Analyzer
        ...
        > **Level:** Advanced · **Project 58** · [`58-ai-document-analyzer`](./)

        Upload contracts and reports for summarization, Q&A, and clause extraction.

        ## Overview

        AI Document Analyzer is a production-oriented full stack application demonstrating modern web development
