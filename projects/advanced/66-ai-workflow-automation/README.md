# AI Workflow Automation
        ...
        > **Level:** Advanced · **Project 66** · [`66-ai-workflow-automation`](./)

        Visual workflow builder connecting apps, AI steps, and triggers.

        ## Overview

        AI Workflow Automation is a production-oriented full stack application demonstrating modern web development
...
- Execution log
        ...
        | Database | DynamoDB |
        | Authentication | JWT |
        | AWS | Step Functions, Lambda, EventBridge, DynamoDB |
