# Data Pipeline Orchestrator
        ...
        > **Level:** Advanced · **Project 72** · [`72-data-pipeline-orchestrator`](./)

        Define ETL pipelines, schedule runs, and monitor data quality.

        ## Overview

        Data Pipeline Orchestrator is a production-oriented full stack application demonstrating modern web development
...
- Lineage
        ...
        | Database | PostgreSQL |
        | Authentication | JWT |
        | AWS | Glue, Step Functions, S3, CloudWatch |
