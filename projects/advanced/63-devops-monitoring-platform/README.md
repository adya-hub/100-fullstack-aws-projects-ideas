# DevOps Monitoring Platform
        ...
        > **Level:** Advanced · **Project 63** · [`63-devops-monitoring-platform`](./)

        Uptime checks, log aggregation, alerts, and incident management.

        ## Overview

        DevOps Monitoring Platform is a production-oriented full stack application demonstrating modern web development
...
- Incidents
        ...
        | AWS | CloudWatch, OpenSearch, SNS, Lambda |
