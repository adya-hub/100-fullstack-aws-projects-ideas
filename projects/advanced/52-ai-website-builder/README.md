# AI Website Builder
        ...
        > **Level:** Advanced · **Project 52** · [`52-ai-website-builder`](./)

        Generate landing pages from prompts with editable components and hosting.

        ## Overview

        AI Website Builder is a production-oriented full stack application demonstrating modern web development
...
- Templates
        ...
        | AWS | Bedrock, S3 sites, CloudFront, Lambda |
