# Kubernetes Operations Dashboard
        ...
        > **Level:** Advanced · **Project 64** · [`64-kubernetes-dashboard`](./)

        Cluster overview, workload health, deployments, and resource metrics.

        ## Overview

        Kubernetes Operations Dashboard is a production-oriented full stack application demonstrating modern web development
...
- RBAC
        ...
        | Database | PostgreSQL |
        | Authentication | OIDC |
        | AWS | EKS, CloudWatch, IAM, Prometheus |
