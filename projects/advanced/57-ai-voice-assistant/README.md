# AI Voice Assistant Platform
        ...
        > **Level:** Advanced · **Project 57** · [`57-ai-voice-assistant`](./)

        Conversational voice agent with tools, memory, and custom personas.

        ## Overview

        AI Voice Assistant Platform is a production-oriented full stack application demonstrating modern web development
...
- Personas
        ...
        | Database | DynamoDB |
        | Authentication | JWT |
        | AWS | Bedrock, Transcribe, Polly, WebSocket API |
