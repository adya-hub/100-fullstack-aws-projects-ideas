# Multi-Vendor Marketplace
        ...
        > **Level:** Advanced · **Project 60** · [`60-multi-vendor-ecommerce`](./)

        Vendor onboarding, commissions, split payments, and catalog management.

        ## Overview

        Multi-Vendor Marketplace is a production-oriented full stack application demonstrating modern web development
