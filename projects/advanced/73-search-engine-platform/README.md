# Custom Search Engine Platform

        > **Level:** Advanced · **Project 73** · [`73-search-engine-platform`](./)

        Crawl, index, and search documents with relevance tuning.

        ## Overview

        Custom Search Engine Platform is a production-oriented full stack application demonstrating modern web development
...
- Analytics
        ...
        | Database | OpenSearch |
        | Authentication | JWT |
        | AWS | OpenSearch, Lambda crawlers, S3 |
