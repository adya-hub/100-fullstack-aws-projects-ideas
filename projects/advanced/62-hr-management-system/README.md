# HR Management System
        ...
        > **Level:** Advanced · **Project 62** · [`62-hr-management-system`](./)

        Employee records, leave management, payroll integration, and org chart.

        ## Overview

        HR Management System is a production-oriented full stack application demonstrating modern web development
