# AI Code Review Platform
        ...
        > **Level:** Advanced · **Project 55** · [`55-ai-code-reviewer`](./)

        GitHub integration for automated PR reviews with security scanning.

        ## Overview

        AI Code Review Platform is a production-oriented full stack application demonstrating modern web development
...
- Custom rules
        ...
        | AWS | Lambda, SQS, Bedrock, Secrets Manager |
