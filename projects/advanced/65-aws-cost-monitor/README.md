# AWS Cost Monitoring Tool
        ...
        > **Level:** Advanced · **Project 65** · [`65-aws-cost-monitor`](./)

        Cost breakdowns, budgets, anomaly detection, and optimization tips.

        ## Overview

        AWS Cost Monitoring Tool is a production-oriented full stack application demonstrating modern web development
...
- Recommendations
        ...
        | Backend | NestJS |
        | Database | DynamoDB |
        | Authentication | IAM cross-account |
        | AWS | Cost Explorer API, Lambda, DynamoDB, SNS |
