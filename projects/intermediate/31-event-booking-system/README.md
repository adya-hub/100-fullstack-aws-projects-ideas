# Event Ticketing Platform
        ...
        > **Level:** Intermediate · **Project 31** · [`31-event-booking-system`](./)

        Event creation, seat selection, ticketing, and QR check-in.

        ## Overview

        Event Ticketing Platform is a production-oriented full stack application demonstrating modern web development
...
- Refunds
        ...
        | Database | PostgreSQL |
        | Authentication | JWT |
        | AWS | RDS, S3 tickets, Lambda QR, SES |
