# Real-Time Chat Application
        ...
        > **Level:** Intermediate · **Project 27** · [`27-real-time-chat-app`](./)

        Channels, direct messages, typing indicators, and message search.

        ## Overview

        Real-Time Chat Application is a production-oriented full stack application demonstrating modern web development
...
- Search
        ...
        | Authentication | JWT |
        | AWS | API Gateway WebSocket, DynamoDB, S3, ElastiCache |
