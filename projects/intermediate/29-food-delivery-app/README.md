# Food Delivery Platform
        ...
        > **Level:** Intermediate · **Project 29** · [`29-food-delivery-app`](./)

        Restaurant menus, cart, delivery tracking, and driver assignment.

        ## Overview

        Food Delivery Platform is a production-oriented full stack application demonstrating modern web development
...
- Ratings
        ...
        | Backend | NestJS |
        | Database | PostgreSQL |
        | Authentication | JWT multi-role |
        | AWS | RDS, SQS, SNS push, Location services |
