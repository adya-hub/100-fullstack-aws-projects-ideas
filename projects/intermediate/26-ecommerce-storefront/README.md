# E-Commerce Storefront
        ...
        > **Level:** Intermediate · **Project 26** · [`26-ecommerce-storefront`](./)

        Full online store with cart, checkout, orders, and admin inventory.

        ## Overview

        E-Commerce Storefront is a production-oriented full stack application demonstrating modern web development
...
- Admin panel
        ...
        | AWS | RDS, S3 products, SES, CloudFront |
