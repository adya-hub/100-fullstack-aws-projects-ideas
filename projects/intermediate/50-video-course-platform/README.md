# Video Course Platform
        ...
        > **Level:** Intermediate · **Project 50** · [`50-video-course-platform`](./)

        Sell video courses with DRM-lite protection and student progress.

        ## Overview

        Video Course Platform is a production-oriented full stack application demonstrating modern web development
...
- Payments
        ...
        | Database | PostgreSQL |
        | Authentication | JWT |
        | AWS | S3, CloudFront signed URLs, RDS |
