# NFT Marketplace
        ...
        > **Level:** Intermediate · **Project 42** · [`42-nft-marketplace-lite`](./)

        Mint, list, and trade digital collectibles with wallet connection.

        ## Overview

        NFT Marketplace is a production-oriented full stack application demonstrating modern web development
...
- Royalties
        ...
        | AWS | S3 metadata, Lambda, API Gateway, CloudFront |
