# Cloud File Storage System
        ...
        > **Level:** Intermediate · **Project 35** · [`35-file-storage-system`](./)

        Upload, organize, share files with versioning and access controls.

        ## Overview

        Cloud File Storage System is a production-oriented full stack application demonstrating modern web development
...
- Preview
        ...
        | Database | PostgreSQL |
        | Authentication | JWT |
        | AWS | S3, CloudFront, Lambda triggers, IAM policies |
