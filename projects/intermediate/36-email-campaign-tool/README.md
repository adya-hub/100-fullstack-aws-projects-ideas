# Email Marketing Campaign Tool
        ...
        > **Level:** Intermediate · **Project 36** · [`36-email-campaign-tool`](./)

        Contact lists, email templates, campaigns, and analytics.

        ## Overview

        Email Marketing Campaign Tool is a production-oriented full stack application demonstrating modern web development
