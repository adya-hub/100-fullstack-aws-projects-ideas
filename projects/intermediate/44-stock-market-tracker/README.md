# Stock Market Analytics
        ...
        > **Level:** Intermediate · **Project 44** · [`44-stock-market-tracker`](./)

        Watchlists, charts, news aggregation, and portfolio simulation.

        ## Overview

        Stock Market Analytics is a production-oriented full stack application demonstrating modern web development
...
- Paper trading
        ...
        | Database | PostgreSQL |
        | Authentication | JWT |
        | AWS | ElastiCache, RDS, Lambda ETL |
