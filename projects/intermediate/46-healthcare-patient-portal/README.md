# Healthcare Patient Portal
        ...
        > **Level:** Intermediate · **Project 46** · [`46-healthcare-patient-portal`](./)

        Appointments, prescriptions, lab results, and secure messaging.

        ## Overview

        Healthcare Patient Portal is a production-oriented full stack application demonstrating modern web development
...
- HIPAA patterns
        ...
        | AWS | RDS encrypted, KMS, CloudTrail, SES |
