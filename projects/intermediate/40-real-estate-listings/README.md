# Real Estate Listings Portal
        ...
        > **Level:** Intermediate · **Project 40** · [`40-real-estate-listings`](./)

        Property listings, advanced search, virtual tours, and agent CRM.

        ## Overview

        Real Estate Listings Portal is a production-oriented full stack application demonstrating modern web development
...
- Favorites
        ...
        | Database | PostgreSQL |
        | Authentication | JWT |
        | AWS | OpenSearch, S3 media, RDS, CloudFront |
