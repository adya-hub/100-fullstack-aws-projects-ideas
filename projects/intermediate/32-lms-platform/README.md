# Learning Management System
        ...
        > **Level:** Intermediate · **Project 32** · [`32-lms-platform`](./)

        Courses, video lessons, quizzes, certificates, and instructor dashboards.

        ## Overview

        Learning Management System is a production-oriented full stack application demonstrating modern web development
...
- Progress
        ...
        | AWS | S3 video, CloudFront, RDS, MediaConvert |
