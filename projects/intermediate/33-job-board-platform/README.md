# Job Board & Applicant Tracking
        ...
        > **Level:** Intermediate · **Project 33** · [`33-job-board-platform`](./)

        Job listings, applications, resume parsing, and employer dashboards.

        ## Overview

        Job Board & Applicant Tracking is a production-oriented full stack application demonstrating modern web development
...
- ATS pipeline
        ...
        | Database | PostgreSQL |
        | Authentication | JWT |
        | AWS | OpenSearch, S3 resumes, Textract, RDS |
