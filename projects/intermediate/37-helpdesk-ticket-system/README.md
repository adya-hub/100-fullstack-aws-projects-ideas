# Helpdesk Ticket System
        ...
        > **Level:** Intermediate · **Project 37** · [`37-helpdesk-ticket-system`](./)

        Support tickets, SLA tracking, agent assignment, and knowledge base.

        ## Overview

        Helpdesk Ticket System is a production-oriented full stack application demonstrating modern web development
