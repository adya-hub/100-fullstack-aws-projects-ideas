# Ride Booking Platform
        ...
        > **Level:** Intermediate · **Project 30** · [`30-ride-booking-app`](./)

        Request rides, driver matching, fare estimation, and trip history.

        ## Overview

        Ride Booking Platform is a production-oriented full stack application demonstrating modern web development
...
- Payments
        ...
        | AWS | DynamoDB, Lambda, SNS, Location |
