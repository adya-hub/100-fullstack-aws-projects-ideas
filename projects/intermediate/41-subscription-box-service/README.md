# Subscription Box Service
        ...
        > **Level:** Intermediate · **Project 41** · [`41-subscription-box-service`](./)

        Recurring subscriptions, box curation, and shipment tracking.

        ## Overview

        Subscription Box Service is a production-oriented full stack application demonstrating modern web development
...
- Skip/pause
        ...
        | Backend | NestJS |
        | Database | PostgreSQL |
        | Authentication | Stripe + JWT |
        | AWS | RDS, SQS fulfillment, SES |
