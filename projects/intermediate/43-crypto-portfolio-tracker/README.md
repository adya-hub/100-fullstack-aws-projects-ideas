# Crypto Portfolio Tracker
        ...
        > **Level:** Intermediate · **Project 43** · [`43-crypto-portfolio-tracker`](./)

        Track holdings, PnL, price alerts, and exchange API sync.

        ## Overview

        Crypto Portfolio Tracker is a production-oriented full stack application demonstrating modern web development
...
- Tax export
        ...
        | Database | DynamoDB |
        | Authentication | JWT |
        | AWS | Lambda price feeds, DynamoDB, ElastiCache |
