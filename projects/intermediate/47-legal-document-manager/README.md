# Legal Document Manager
        ...
        > **Level:** Intermediate · **Project 47** · [`47-legal-document-manager`](./)

        Contract storage, e-signatures, version control, and audit trails.

        ## Overview

        Legal Document Manager is a production-oriented full stack application demonstrating modern web development
...
- Templates
        ...
        | AWS | S3, KMS, CloudTrail, Textract |
