# Social Media Network
        ...
        > **Level:** Intermediate · **Project 34** · [`34-social-media-app`](./)

        Posts, feeds, follows, likes, comments, and notifications.

        ## Overview

        Social Media Network is a production-oriented full stack application demonstrating modern web development
...
- Media posts
        ...
        | AWS | DynamoDB, S3, SQS fanout, ElastiCache |
